...
public class Login extends javax.swing.JFrame {
    ...
    public Login(){
        ...
        txtPassword.setBorder(BorderFactory.createMatteBorder(2,2,2,2, Color.GRAY));            // BORDER AND BORDER COLOUR FOR TEXTFIELD
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from admin where uname = '"+email+"';");
            rs.next();
            String nm = rs.getString("uname");
            String ps = rs.getString("upass");
            if((email.equals(nm)) && (password.equals(ps)))
            {
                this.dispose();
