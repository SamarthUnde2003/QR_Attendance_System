...
// THIS PROGRAM IS TO SET IMAGE TO BACKGROUND WITH PERFECT SIZE AS THE PAGE SIZE IS GIVEN....


public class BDUtility {
    

    public static void setImage(JFrame frame,String imagePath,int newWidth,int newHeight){  // SET THE SIZE OF IMAGE 
...
// manages the visibility of different JFrame windows in a Java Swing application.....
    ...
    public static String getPath(String finalPath){
        ...
        System.out.println("image save with path");
    ...
    public static String getFileExtention(String fileName){
        ...
        if(lastDotIndex != -1){
            System.out.println("image save with extention");
